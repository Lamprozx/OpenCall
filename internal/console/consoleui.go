...
var (
	// TermOut is where log/console output is written. Defaults to stderr and is
	// replaced by the interactive UI when one is active.
	TermOut io.Writer = os.Stderr
	// TermUI is the active interactive console, or nil when running non-interactively.
	TermUI *ConsoleUI
)
