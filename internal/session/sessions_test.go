...
func TestRegistryRoundtripAndUniqueness(t *testing.T) {
	...
	r := &Registry{}
	now := time.Now()
	if err := r.Add(Record{ID: "abc12345", Name: "udin", Phone: "6281", JID: "6281@s.whatsapp.net", CreatedAt: now, LastUsed: now}); err != nil {
		t.Fatal(err)
	}
	...
	if err := r2.Add(Record{ID: "deadbeef", Name: "udin", Phone: "6282"}); err == nil {
...
func TestByJID(t *testing.T) {
	r := &Registry{}
	r.Sessions = append(r.Sessions, Record{ID: "a", JID: "6281@s.whatsapp.net"})
...
func TestRemoveDeletesDir(t *testing.T) {
	...
	r := &Registry{}
	if err := r.Add(Record{ID: "abc12345", Name: "udin", Phone: "6281"}); err != nil {
		t.Fatal(err)
	}
	if err := r.SetActive("abc12345"); err != nil {
		t.Fatal(err)
...
func TestUnusedName(t *testing.T) {
	r := &Registry{}
	r.Sessions = append(r.Sessions, Record{ID: "a", Name: "default"})
	...
	r.Sessions = append(r.Sessions, Record{ID: "b", Name: "default2"})
