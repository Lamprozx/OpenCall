...
// ConsoleMinLevel gates console output when --diag is active so the terminal
// keeps the requested verbosity while diagnostics capture full debug data.
var ConsoleMinLevel atomic.Int32

// DiagCtxKey carries the *diag.Recorder through context.
